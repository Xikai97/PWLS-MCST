...
load('./data_XCAT/slice20/slice#20_420.mat');  % Make it consistent with Recon slice!
...
save(sprintf('./recon_mcst_XCAT/XCATRecon_slice20_%.1e_%g_%gblk_%.1ebeta_%g_%ggam_learn80_60_iter%g_nodropmean_%gPatchSize.mat', I0, ...
